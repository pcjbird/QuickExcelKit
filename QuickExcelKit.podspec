...
#s.preserve_paths   = ''
    ...
    s.pod_target_xcconfig = { 'OTHER_LDFLAGS' => '-lObjC', 'HEADER_SEARCH_PATHS' => '(${PODS_ROOT}/DHlibxls/libxls,${PODS_ROOT}/DHlibxls/libxls/include,${PODS_ROOT}/DHlibxls/libxls/include/libxls,${PODS_ROOT}/ZXLSXReader,${PODS_ROOT}/ZXLSXReader/xmlParser,${PODS_ROOT}/ZXLSXReader/xmlParser/models,)' }
